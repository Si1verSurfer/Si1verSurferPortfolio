    ...
    <div className="min-h-screen bg-deep-space noise-overlay">
      ...
      <header className="sticky top-0 z-50 border-b border-border/80 bg-card/80 backdrop-blur-xl">
        <div className="flex min-h-[48px] items-center gap-3 px-4 py-2 sm:px-6">
          ...
          <Link
            href="/#projects"
            className="flex items-center gap-2 rounded-lg border border-border px-3 py-2 text-sm text-silver hover:border-cosmic-blue/50 hover:bg-cosmic-blue/10 hover:text-cosmic-blue transition-all"
          >
        ...
        <section className="mb-16 md:mb-24">
          <div className="flex flex-col items-center text-center mb-10">
            ...
            <p className="text-muted-foreground font-mono text-sm md:text-base flex items-center gap-2">
              <Monitor className="h-4 w-4 text-cosmic-blue" />
              Web Dashboard · {project.role}
            </p>
          </div>

          <div className="relative w-full max-w-5xl mx-auto">
            <div className="rounded-xl border border-border/80 bg-card/50 shadow-[0_0_0_1px_rgba(74,159,255,0.08),0_25px_80px_-20px_rgba(0,0,0,0.5)] overflow-hidden energy-border">
